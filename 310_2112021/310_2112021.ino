...
void loop()
{
  ...
  if (distance_in_cmL < 9 || distance_in_cmR < 9) {
    STOP();
  }

  else if (distance_in_cmL < 25 || distance_in_cmR < 25) {   //ultrosonic take over
    if (distance_in_cmR - distance_in_cmL >= 5) {
      rotate_2();
      delay(100);
      STOP();
    }

    else if (distance_in_cmL - distance_in_cmR >= 5) {
      rotate_1();
      delay(100);
      STOP();
    ...
    else if ( distance_in_cmR - distance_in_cmL >= 10 ) {
      LEFT_2();
    }
    else if ( distance_in_cmL - distance_in_cmR >= 10 ) {
      RIGHT_2();
    }
